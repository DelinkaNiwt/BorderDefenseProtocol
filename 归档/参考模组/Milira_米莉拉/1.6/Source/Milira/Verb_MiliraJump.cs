...
public class Verb_MiliraJump : Verb
{
	...
	protected override bool TryCastShot()
	{
		...
		VerbProperties verbProperties = verbProps;
		ThingDef milira_PawnJumper = MiliraDefOf.Milira_PawnJumper;
		return JumpUtility.DoJump(casterPawn, localTargetInfo, reloadableCompSource, verbProperties, null, default(LocalTargetInfo), milira_PawnJumper);
	}
