...
public class Dialog_AssignWorldObjectOwner_Caravan : Window
{
	private WorldObjectComp_AssignableToPawn_Caravan assignable;
	...
	public Dialog_AssignWorldObjectOwner_Caravan(WorldObjectComp_AssignableToPawn_Caravan assignable, Caravan caravan)
	{
	...
	public override void DoWindowContents(Rect inRect)
	{
		...
		num += (float)assignable.AssigningCandidates(caravan).Count() * 35f;
		num += 7f;
		...
		SortTmpList(assignable.AssigningCandidates(caravan));
