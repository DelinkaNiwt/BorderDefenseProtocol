...
public class PawnColumnWorker_MechWorkPriority : PawnColumnWorker
{
	...
	public override void DoCell(Rect rect, Pawn pawn, PawnTable table)
	{
		...
		WidgetsMechWork.DrawWorkBoxFor(x, y, pawn, def.workType, incapable);
		Rect rect2 = new Rect(x, y, 25f, 25f);
		if (Mouse.IsOver(rect2))
		{
			TooltipHandler.TipRegion(rect2, () => WidgetsMechWork.TipForPawnWorker(pawn, def.workType, incapable), pawn.thingIDNumber ^ def.workType.GetHashCode());
		}
