...
namespace BDP.Trigger
{
    ...
    public class CompTriggerBody : CompEquippable, IVerbOwner
    {
        ...
        private void CreateVolleyVerbs(Pawn pawn)
        {
            ...
            {
                var volleyType = leftCfg.supportsGuided ? typeof(Verb_BDPGuidedVolley) : typeof(Verb_BDPVolley);
            ...
            {
                var volleyType = rightCfg.supportsGuided ? typeof(Verb_BDPGuidedVolley) : typeof(Verb_BDPVolley);
