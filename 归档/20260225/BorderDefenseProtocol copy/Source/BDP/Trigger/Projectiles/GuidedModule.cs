...
{
    /// <summary>
    /// 引导飞行模块——从Bullet_BDP + Verb_BDPGuided提取的折线弹道逻辑。
    ...
    /// </summary>
    public class GuidedModule : IBDPProjectileModule
    {
        ...
        /// <summary>
        /// 到达中间锚点时拦截Impact，重定向飞行到下一路径点。
        /// 返回true=已重定向（宿主跳过base.ImpactSomething）。
        /// </summary>
        public bool OnPreImpact(Bullet_BDP host)
        {
        ...
        public bool OnImpact(Bullet_BDP host, Thing hitThing) => false;
