...
public class CompAbilityEffect_LanceCharge : CompAbilityEffect
{
	private List<IntVec3> tmpCells = new List<IntVec3>();

	private new CompProperties_AbilityLanceCharge Props => (CompProperties_AbilityLanceCharge)props;
	...
	public override bool AICanTargetNow(LocalTargetInfo target)
	{
		...
		{
			foreach (IntVec3 item in GenRadial.RadialCellsAround(Pawn.Position, Props.range, useCenter: true))
			{
