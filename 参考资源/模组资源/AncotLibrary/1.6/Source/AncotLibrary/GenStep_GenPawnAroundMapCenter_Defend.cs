...
public class GenStep_GenPawnAroundMapCenter_Defend : GenStep
{
	...
	public override void Generate(Map map, GenStepParams parms)
	{
		...
		if (list.Any())
		{
			LordMaker.MakeNewLord(faction, new LordJob_DefendPoint(singleCellToSpawnNear, 12f, 35f), map, list);
		}
	}
}
