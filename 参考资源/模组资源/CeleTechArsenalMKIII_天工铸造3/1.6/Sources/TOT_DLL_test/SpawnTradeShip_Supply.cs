...
public class SpawnTradeShip_Supply
{
	...
	{
		Thing thing = ThingMaker.MakeThing(CMC_Def.CMC_TraderShuttle);
		TradeShip tradeShip = new TradeShip(DefDatabase<TraderKindDef>.GetNamed("CMC_OrbitalTrader_Materials"));
