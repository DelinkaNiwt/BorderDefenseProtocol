...
public static class TogglePatch
{
	...
	public static void Postfix(WidgetRow row, bool worldView)
	{
		...
		bool overlayEnabled = settings.OverlayEnabled;
		row.ToggleableIcon(ref overlayEnabled, RimTalkToggleIcon, "RimTalk.Toggle.Tooltip".Translate(), SoundDefOf.Mouseover_ButtonToggle);
