...
namespace GD3
{
	public class GenStep_CustomStructureGen_WithMusic : GenStep
	{
		...
		public override void Generate(Map map, GenStepParams parms)
		{
			...
			Faction forcedFaction = Find.FactionManager.FirstFactionOfDef(forcedfaction) ?? map.ParentFaction;
			structureLayoutDef.Generate(rect, map, forcedFaction);
