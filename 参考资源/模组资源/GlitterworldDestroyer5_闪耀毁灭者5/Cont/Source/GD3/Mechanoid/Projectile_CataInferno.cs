...
namespace GD3
{
    public class CataFlameBomb : ThingWithComps
    {
        public override void ExposeData()
        {
            base.ExposeData();
            Scribe_Values.Look<int>(ref this.spawnTick, "spawnTick", 0, false);
            Scribe_Values.Look<float>(ref this.impactAreaRadius, "impactAreaRadius", 6.9f, false);
        }
            ...
            else
            {
                ...
                if (Spawned)
                {
                    if (spawnTick % 10 == 0 && spawnTick != 0)
                    {
                        ...
                        {
                            StartRandomFire();
                            GenExplosion.DoExplosion(nextExplosionCell, map, 5.9f, DamageDefOf.Flame, null, 40, 0.6f, null, GDDefOf.CataphractCentipede_FY, this.def, null, null, 0f, 1, null, null, 255, false, null, 0f, 1, 0f, false, null, null, null, true, 1f, 0f, true, null, 1f);
                        }
                    }
                    this.spawnTick++;
                }
