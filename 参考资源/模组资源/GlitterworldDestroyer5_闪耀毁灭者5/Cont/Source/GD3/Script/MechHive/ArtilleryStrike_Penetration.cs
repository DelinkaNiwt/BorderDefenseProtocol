...
namespace GD3
{
    ...
    public class ArtilleryStrike_Penetration : Thing
    {
        private Effecter attachedEffecter;

        public int tickToImpact = -1;

        public static readonly int tickInBound = 600;

        public static readonly int lifetime = 300;

        public static readonly float radius = 12.9f;
        ...
        protected override void Tick()
        {
            ...
            if (tick > tickToImpact)
            {
                if (this.IsHashIntervalTick(20))
                {
                    ...
                    Thing shell = ThingMaker.MakeThing(GDDefOf.GD_PenetrationArtilleryShell);
