...
namespace GD3
{
    ...
    public class ArtilleryStrike_EMP : Thing
    {
        private Effecter attachedEffecter;

        public int tickToImpact = -1;

        public static readonly int tickInBound = 180;

        public static readonly int lifetime = 1;

        public static readonly float radius = 29.9f;
        ...
        protected override void Tick()
        {
            ...
            if (tick > tickToImpact)
            {
                ...
                {
                    MapHeld.weatherManager.eventHandler.AddEvent(new WeatherEvent_LightningStrike(MapHeld, PositionHeld));
                    FleckMaker.ThrowLightningGlow(DrawPos, MapHeld, 9f);
                    GenExplosion.DoExplosion(PositionHeld, MapHeld, radius, DamageDefOf.EMP, null, 150, -1, null, null, null, null, null, 0.2f, 1, null, null, 255, false, null, 0f, 1, 0, false, null, null, null, true, 1f, 0f, true, null, 1f);
                    GDDefOf.GDDistantArtilleryEMP.PlayOneShot(new TargetInfo(PositionHeld, MapHeld));
        ...
        protected override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            ...
            if (!Destroyed)
            {
                ...
                Color color = new Color(30, 144, 255, 242);
                color.a *= num3;
