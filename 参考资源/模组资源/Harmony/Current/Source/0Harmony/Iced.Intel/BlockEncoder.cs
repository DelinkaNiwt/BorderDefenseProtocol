...
internal sealed class BlockEncoder
{
	...
	public static bool TryEncode(int bitness, InstructionBlock block, [_003C1308eb90_002D8064_002D4e43_002Db224_002Dde8c2b9aa062_003ENotNullWhen(false)] out string? errorMessage, out BlockEncoderResult result, BlockEncoderOptions options = BlockEncoderOptions.None)
	{
	...
	public static bool TryEncode(int bitness, InstructionBlock[] blocks, [_003C1308eb90_002D8064_002D4e43_002Db224_002Dde8c2b9aa062_003ENotNullWhen(false)] out string? errorMessage, [_003C1308eb90_002D8064_002D4e43_002Db224_002Dde8c2b9aa062_003ENotNullWhen(true)] out BlockEncoderResult[]? result, BlockEncoderOptions options = BlockEncoderOptions.None)
	{
		return new BlockEncoder(bitness, blocks, options).Encode(out errorMessage, out result);
	}

	private bool Encode([_003C1308eb90_002D8064_002D4e43_002Db224_002Dde8c2b9aa062_003ENotNullWhen(false)] out string? errorMessage, [_003C1308eb90_002D8064_002D4e43_002Db224_002Dde8c2b9aa062_003ENotNullWhen(true)] out BlockEncoderResult[]? result)
	{
		Block[] array;
		for (int i = 0; i < 5; i++)
		{
