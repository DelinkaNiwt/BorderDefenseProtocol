...
internal sealed class PlatformTriple
{
	...
	public SimpleNativeDetour CreateSimpleDetour(IntPtr from, IntPtr to, int detourMaxSize = -1, IntPtr fromRw = default(IntPtr))
	{
		...
		_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(31, 2, out isEnabled);
		if (isEnabled)
		{
	...
	public NativeDetour CreateNativeDetour(IntPtr from, IntPtr to, int detourMaxSize = -1, IntPtr fromRw = default(IntPtr))
	{
		...
		{
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler message3 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(67, 2, out isEnabled);
			if (isEnabled)
			{
			...
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Warning(ref message3);
		}
		byte[] array = new byte[nativeDetourInfo.Size];
		System.PatchData(PatchTargetKind.Executable, fromRw, span, array);
	...
	private unsafe IntPtr GetNativeMethodBodyWalk(MethodBase method, bool reloadPtr)
	{
		...
		bool isEnabled;
		_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(32, 1, out isEnabled);
		if (isEnabled)
		{
		...
		while (true)
		{
			...
			message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(25, 1, out isEnabled);
			if (isEnabled)
			{
			...
			while (true)
			{
				if (value++ > 20)
				{
					_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(70, 4, out isEnabled);
					if (isEnabled)
					{
				...
				if (flag2 || num != num2)
				{
					...
					{
						_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler message3 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(43, 2, out isEnabled);
						if (isEnabled)
						{
					...
					if (knownMethodThunks.TryFindMatch(data, out ulong address, out BytePattern matchingPattern, out int offset, out int _))
					{
						...
						message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(46, 4, out isEnabled);
						if (isEnabled)
						{
						...
						if (addressMeaning.Kind.IsPrecodeFixup() && !flag)
						{
							...
							if (reloadPtr)
							{
								message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(56, 1, out isEnabled);
								if (isEnabled)
								{
						...
						message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(23, 1, out isEnabled);
						if (isEnabled)
						{
						...
						{
							_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Trace("Matched ThePreStub");
							Compile(method);
							break;
						}
						continue;
	...
	private IntPtr NotThePreStub(IntPtr ptrGot, IntPtr ptrParsed, out bool wasPreStub)
	{
		if (ThePreStub == IntPtr.Zero)
		{
			...
			bool isEnabled;
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(14, 1, out isEnabled);
			if (isEnabled)
			{
