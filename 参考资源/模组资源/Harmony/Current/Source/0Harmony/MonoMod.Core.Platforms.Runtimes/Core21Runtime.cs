		...
		public unsafe CoreCLR.CorJitResult CompileMethodHook(IntPtr jit, IntPtr corJitInfo, CoreCLR.V21.CORINFO_METHOD_INFO* methodInfo, uint flags, byte** pNativeEntry, uint* pNativeSizeOfCode)
		{
			...
			*pNativeSizeOfCode = 0u;
			...
			try
			{
				...
				{
					bool isEnabled;
					_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(59, 1, out isEnabled);
					if (isEnabled)
					{
