...
internal abstract class CoreBaseRuntime : FxCoreBaseRuntime, IInitialize
{
	...
	protected virtual string GetClrJitPath()
	{
		...
		if (Switches.TryGetSwitchValue("JitPath", out object value))
		{
			...
			if (jitPath != null)
			{
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler message;
				if (!IsMaybeClrJitPath(jitPath))
				{
					message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(77, 1, out isEnabled);
					if (isEnabled)
					{
				...
				else
				{
					...
					if (text == null)
					{
						message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(82, 1, out isEnabled);
						if (isEnabled)
						{
		...
		_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(14, 1, out isEnabled);
		if (isEnabled)
		{
