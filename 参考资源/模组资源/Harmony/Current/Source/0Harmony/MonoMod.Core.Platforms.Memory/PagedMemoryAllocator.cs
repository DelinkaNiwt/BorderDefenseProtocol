...
internal abstract class PagedMemoryAllocator : IMemoryAllocator
{
	...
	protected sealed class Page
	{
		...
		public bool TryAllocate(uint size, uint align, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out PageAllocation alloc)
		{
			lock (sync)
			{
	...
	private bool DoCleanup()
	{
		...
		while (pagesToClean.TryTake(out result))
		{
			...
			{
				bool isEnabled;
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(27, 1, out isEnabled);
				if (isEnabled)
				{
	...
	protected abstract bool TryFreePage(Page page, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003ENotNullWhen(false)] out string? errorMsg);

	public bool TryAllocateInRange(PositionedAllocationRequest request, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated)
	{
	...
	private static bool TryAllocWithPage(Page page, PositionedAllocationRequest request, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated)
	{
	...
	public bool TryAllocate(AllocationRequest request, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated)
	{
		if (request.Size < 0)
		{
			throw new ArgumentException("Size is negative", "request");
	...
	protected abstract bool TryAllocateNewPage(AllocationRequest request, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated);

	protected abstract bool TryAllocateNewPage(PositionedAllocationRequest request, nint targetPage, nint lowPageBound, nint highPageBound, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated);
}
