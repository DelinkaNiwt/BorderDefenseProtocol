...
internal sealed class BytePatternCollection : IEnumerable<BytePattern>, IEnumerable
{
	...
	public bool TryMatchAt(ReadOnlySpan<byte> data, out ulong address, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int length)
	{
	...
	public bool TryMatchAt(ReadOnlySpan<byte> data, Span<byte> addrBuf, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int length)
	{
		if (data.Length < MinLength)
		{
			length = 0;
	...
	public bool TryFindMatch(ReadOnlySpan<byte> data, out ulong address, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int offset, out int length)
	{
		if (data.Length < MinLength)
		{
			length = (offset = 0);
	...
	public bool TryFindMatch(ReadOnlySpan<byte> data, Span<byte> addrBuf, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out BytePattern matchingPattern, out int offset, out int length)
	{
		if (data.Length < MinLength)
		{
			length = (offset = 0);
