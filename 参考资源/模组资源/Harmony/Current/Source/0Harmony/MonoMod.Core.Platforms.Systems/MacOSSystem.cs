...
internal sealed class MacOSSystem : ISystem, IInitialize<IArchitecture>
{
	private sealed class MacOsQueryingAllocator : QueryingMemoryPageAllocatorBase
	{
		...
		public unsafe override bool TryAllocatePage(nint size, bool executable, out IntPtr allocated)
		{
			...
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message;
			bool isEnabled;
			if (PlatformDetection.Architecture == ArchitectureKind.Arm64 && vm_prot_t == OSX.vm_prot_t.All)
			{
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Trace("RWX memory detected, doing mmap with MAP_JIT");
				...
				if (allocated == (IntPtr)(-1))
				{
					...
					message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(37, 2, out isEnabled);
					if (isEnabled)
					{
				...
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(37, 2, out isEnabled);
				if (isEnabled)
				{
			...
			if (!kern_return_t)
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(41, 1, out isEnabled);
				if (isEnabled)
				{
		...
		public unsafe override bool TryAllocatePage(IntPtr pageAddr, nint size, bool executable, out IntPtr allocated)
		{
			...
			if (PlatformDetection.Architecture == ArchitectureKind.Arm64 && vm_prot_t == OSX.vm_prot_t.All)
			{
				...
				if (allocated == (IntPtr)(-1))
				{
					int errno = OSX.Errno;
					Win32Exception value = new Win32Exception(errno);
					_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(37, 2, out isEnabled);
					if (isEnabled)
					{
						message.AppendLiteral("Error creating allocation anywhere! ");
						message.AppendFormatted(errno);
				...
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(45, 2, out isEnabled);
				if (isEnabled)
				{
			...
			if (!kern_return_t)
			{
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogSpamStringHandler message3 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogSpamStringHandler(38, 2, out isEnabled);
				if (isEnabled)
				{
				...
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Spam(ref message3);
				allocated = default(IntPtr);
				return false;
			}
			allocated = (IntPtr)(long)num;
		...
		public override bool TryFreePage(IntPtr pageAddr, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003ENotNullWhen(false)] out string? errorMsg)
		{
	...
	private sealed class MacOSNativeLibDrop : PosixNativeLibraryDrop
	{
		...
		protected unsafe override nint Mkstemp(Span<byte> template)
		{
			...
			if (num == -1)
			{
				...
				bool isEnabled;
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(29, 2, out isEnabled);
				if (isEnabled)
				{
	...
	public unsafe void PatchData(PatchTargetKind targetKind, IntPtr patchTarget, ReadOnlySpan<byte> data, Span<byte> backup)
	{
		...
		if (TryGetProtForMem(patchTarget, length, out var _, out var prot, out var crossesAllocBoundary, out var notAllocated))
		{
			...
			{
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogWarningStringHandler(101, 2, out isEnabled);
				if (isEnabled)
				{
		...
		else
		{
			if (notAllocated)
			{
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(68, 2, out isEnabled);
				if (isEnabled)
				{
				...
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Error(ref message2);
		...
		{
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Trace("RWX memory detected, doing memcpy for MAP_JIT");
			fixed (byte* ptr = data)
			{
				jitMemcpyHelper.JitMemCpy(patchTarget, (IntPtr)ptr, (ulong)data.Length);
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message3 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(20, 2, out isEnabled);
				if (isEnabled)
				{
				...
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Trace(ref message3);
			}
		}
		else
		{
	...
	private unsafe static void MakePageWritable(nint addrInPage)
	{
		...
		if (maxProt.Has(OSX.vm_prot_t.Write))
		{
			...
			message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(60, 6, out isEnabled);
			if (isEnabled)
			{
			...
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Error(ref message);
			_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.Error("Trying copy/remap instead...");
		}
		if (!prot.Has(OSX.vm_prot_t.Read))
		{
			if (!maxProt.Has(OSX.vm_prot_t.Read))
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(66, 3, out isEnabled);
				if (isEnabled)
				{
			...
			if (!kern_return_t)
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(60, 4, out isEnabled);
				if (isEnabled)
				{
		...
		_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler message2 = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogTraceStringHandler(41, 5, out isEnabled);
		if (isEnabled)
		{
		...
		if (!kern_return_t)
		{
			message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(36, 1, out isEnabled);
			if (isEnabled)
			{
		...
		try
		{
			...
			if (!kern_return_t)
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(79, 4, out isEnabled);
				if (isEnabled)
				{
			...
			if (!kern_return_t)
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(78, 10, out isEnabled);
				if (isEnabled)
				{
		...
		finally
		{
			...
			if (!kern_return_t)
			{
				message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(53, 3, out isEnabled);
				if (isEnabled)
				{
