...
internal sealed class LinuxSystem : ISystem, IInitialize<IArchitecture>
{
	private sealed class MmapPagedMemoryAllocator : PagedMemoryAllocator
	{
		...
		protected override bool TryAllocateNewPage(AllocationRequest request, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated)
		{
			...
			{
				int errno = Unix.Errno;
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(28, 2, out isEnabled);
				if (isEnabled)
				{
		...
		protected override bool TryAllocateNewPage(PositionedAllocationRequest request, nint targetPage, nint lowPageBound, nint highPageBound, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMaybeNullWhen(false)] out IAllocatedMemory allocated)
		{
		...
		protected override bool TryFreePage(Page page, [_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003ENotNullWhen(false)] out string? errorMsg)
		{
