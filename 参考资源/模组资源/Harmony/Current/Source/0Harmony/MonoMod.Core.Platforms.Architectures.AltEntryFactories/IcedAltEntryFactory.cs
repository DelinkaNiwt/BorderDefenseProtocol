	...
	public IntPtr CreateAlternateEntrypoint(IntPtr entrypoint, int minLength, out IDisposable? handle)
	{
		...
		while (true)
		{
			...
			if (!BlockEncoder.TryEncode(bitness, new InstructionBlock(bufferCodeWriter, instructionList, (ulong)(long)baseAddress), out string errorMessage, out BlockEncoderResult _))
			{
				allocated.Dispose();
				bool isEnabled;
				_003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler message = new _003C49fa8ad6_002D48f4_002D474b_002Db220_002D56b3c5b5008b_003EMMDbgLog.DebugLogErrorStringHandler(44, 1, out isEnabled);
				if (isEnabled)
				{
