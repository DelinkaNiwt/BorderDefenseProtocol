...
internal class WorkGiver_RebuildBrokenShellcoreBastion : WorkGiver_Scanner
{
	...
	public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(DefDatabase<ThingDef>.GetNamed("Broken_Shellcore_Bastion"));

	public override PathEndMode PathEndMode => PathEndMode.Touch;

	public static void ResetStaticData()
	{
		NoWortBTrans = "NCL_SHELLCORE_NO_MATERIAL".Translate();
	}
	...
	public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
	{
		...
		return JobMaker.MakeJob(DefDatabase<JobDef>.GetNamed("RebuildBrokenShellcoreBastion"), t, t2);
	}
