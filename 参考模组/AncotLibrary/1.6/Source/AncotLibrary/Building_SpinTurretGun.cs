...
public class Building_SpinTurretGun : Building_Turret
{
	...
	public float ShootAngleLimit => this.GetStatValue(AncotDefOf.Ancot_TurretShootAngleLimit);

	public float TurretRotateSpeed => this.GetStatValue(AncotDefOf.Ancot_TurretRotateSpeed) / 60f;
	...
	public bool Active
	{
		get
		{
			...
			return (powerComp == null || powerComp.PowerOn) && (dormantComp == null || dormantComp.Awake) && (initiatableComp == null || initiatableComp.Initiated) && (interactableComp == null || burstActivated) && (powerCellComp == null || !powerCellComp.depleted) && (hackableComp == null || !hackableComp.IsHacked);
		}
	}

	public bool NpAndHoldFire => base.PowerComp == null && holdFire && CanToggleHoldFire;
	...
	protected bool PlayerControlled => (base.Faction == Faction.OfPlayer || MannedByColonist) && !MannedByNonColonist && !IsActivable;
	...
	public Building_SpinTurretGun()
	{
		top = new SpinTurretTop(this);
	}
	...
	public override void ExposeData()
	{
		...
		Scribe_Values.Look(ref curRotationInt, "curRotationInt", 0f);
	...
	protected override void Tick()
	{
		...
		if (Active && (mannableComp == null || mannableComp.MannedNow) && !base.IsStunned && base.Spawned)
		{
			...
			else if (AttackVerb.state == VerbState.Bursting)
			{
				top.TurretTopTick();
				if (!top.CanContinueShoot)
				{
					BurstComplete();
					ResetCurrentTarget();
				}
	...
	protected IAttackTargetSearcher TargSearcher()
	{
	...
	protected bool IsValidTarget(Thing t)
	{
		if (t is Pawn pawn)
		{
	...
	protected override void DrawAt(Vector3 drawLoc, bool flip = false)
	{
		...
		if (IsMortar)
		{
			EquipmentUtility.Recoil(def.building.turretGunDef, (Verb_LaunchProjectile)AttackVerb, out drawOffset, out angleOffset, CurRotation);
		}
	...
	public override IEnumerable<Gizmo> GetGizmos()
	{
		...
		if (!HideForceTargetGizmo)
		{
			...
			if (forcedTarget.IsValid)
			{
				Command_Action command_Action = new Command_Action
				{
					...
					icon = AncotLibraryIcon.VanillaHalt,
					action = delegate
					{
						ResetForcedTarget();
		...
		yield return new Command_Toggle
		{
			...
			icon = AncotLibraryIcon.VanillaHoldFire,
	...
	{
		CurRotation = base.Rotation.AsAngle;
	}
}
