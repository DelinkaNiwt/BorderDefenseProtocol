...
public class MechCarrierGizmo_Custom : Gizmo
{
	private CompMechCarrier_Custom carrier;
	...
	public MechCarrierGizmo_Custom(CompMechCarrier_Custom carrier)
	{
	...
	private string GetResourceBarTip()
	{
		...
		stringBuilder.AppendInNewLine("MechCarrierAutofillDesc".Translate(carrier.parent.def.label, carrier.Props_Mech.spawnPawnKind.labelPlural));
