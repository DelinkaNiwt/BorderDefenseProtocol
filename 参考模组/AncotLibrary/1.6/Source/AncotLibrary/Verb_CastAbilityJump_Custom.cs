...
public class Verb_CastAbilityJump_Custom : Verb_CastAbility
{
	...
	protected override bool TryCastShot()
	{
		if (base.TryCastShot())
		{
			return JumpUtility_Custom.DoJump(CasterPawn, currentTarget, base.ReloadableCompSource, verbProps, ability, base.CurrentTarget, JumpFlyerDef);
		}
		return false;
	}
