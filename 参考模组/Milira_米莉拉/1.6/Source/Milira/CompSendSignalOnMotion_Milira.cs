...
public class CompSendSignalOnMotion_Milira : ThingComp
{
	...
	public CompProperties_SendSignalOnMotion_Milira Props => (CompProperties_SendSignalOnMotion_Milira)props;
	...
	{
		Effecter effecter = new Effecter(MiliraDefOf.Milira_ActivatorProximityTriggered);
