---
标题：3.2 RimWorld技术框架笔记
版本号: v0.9
更新日期: 2026-02-16
最后修改者: Claude Opus 4.6
标签：[文档][用户未确认][未完成][未锁定]
摘要: RimWorld代码架构与技术框架的系统性笔记。定位于技术实现层面——"RimWorld用什么Def/Comp/Worker来实现这些系统"。与3.1（游戏规则）互补，为第四阶段技术映射验证提供代码级参考。
---
...
**本文档不是什么**：不是游戏规则说明（那是3.1的职责），不是模组选型方案（那是3.3的职责）。

**3.1 / 3.2 / 3.3 三者边界**：
- 3.1 游戏系统笔记 → "游戏里有什么规则"（玩家视角）
- 3.2 技术框架笔记 → "代码里怎么实现的"（开发者视角）← 本文档
- 3.3 技术选型笔记 → "RimWT该怎么做"（模组设计视角）
